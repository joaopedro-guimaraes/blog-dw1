...
<form method="post" action="update.php?acao=criarEvento">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault03" placeholder="Descrição" name="descricao" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-6 mb-3">
      <label for="validationDefault03">Endereço</label>
      <input type="text" class="form-control" id="validationDefault03" placeholder="Endereço" name="endereco" required>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationDefault05">Data e Hora</label>
      <input type="text" class="form-control" id="data" placeholder="YYYY-mm-DD HH:MM:SS" name="data" required>
    </div>
  </div>
